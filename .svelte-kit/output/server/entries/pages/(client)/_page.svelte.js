import { C as attr, a as head, c as stringify, d as html, i as ensure_array_like, n as attr_style, w as escape_html } from "../../../chunks/server.js";
...
function About($$renderer) {
	$$renderer.push(`<section class="w-full bg-white py-16 md:py-24"><div class="max-w-[1500px] mx-auto px-6"><div class="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center"><div class="flex flex-col items-start"><h2 class="text-4xl md:text-[42px] font-serif font-bold text-black mb-6">Tentang Mengeruda</h2> <p class="text-[17px] md:text-lg font-serif text-gray-800 leading-relaxed mb-8 text-justify">Dolor eiusmod mollit cupidatat officia consequat in elit tempor. Ex deserunt reprehenderit ad anim do adipiscing aute. Pariatur voluptate dolore deserunt nisi fugiat ea ut adipiscing mollit irure. Et aliquip enim laboris nisi eiusmod aute cillum consequat dolore et deserunt. In consequat excepteur in velit sint commodo minim duis.</p> <a href="/profil" class="bg-[#00a651] hover:bg-[#008f45] text-white font-medium text-[17px] py-3 px-8 rounded-full transition-colors duration-300 shadow-sm inline-block">Selengkapnya</a></div> <div class="w-full flex justify-center"><img src="/peta-mengeruda.png" alt="Ilustrasi Peta Desa Mengeruda" class="w-full max-w-[600px] h-auto object-contain drop-shadow-lg hover:scale-105 transition-transform duration-500"/></div></div></div></section>`);
}
//#endregion
//#region src/lib/components/AdministrasiPenduduk.svelte
function AdministrasiPenduduk($$renderer) {
	const statistik = [
		{
			id: "penduduk",
			label: "Penduduk",
	...
	$$renderer.push(`<section class="w-full bg-white py-12"><div class="max-w-[1500px] mx-auto px-6"><div class="bg-[#eef8f1] border-2 border-[#00a651] rounded-[2rem] px-6 py-12 md:p-14 shadow-sm"><div class="text-center mb-10"><h2 class="text-3xl md:text-4xl font-serif font-bold text-[#00a651] mb-4">Administrasi Penduduk</h2> <p class="text-gray-800 font-serif text-base md:text-lg max-w-3xl mx-auto leading-relaxed">Dolor eiusmod mollit cupidatat officia consequat in elit tempor. Ex deserunt
          reprehenderit ad anim do adipiscing aute.</p></div> <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto"><!--[-->`);
...
function StrukturOrganisasi($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<section class="w-full bg-white py-16"><div class="max-w-[1500px] mx-auto px-6"><div class="text-center mb-12"><h2 class="text-3xl md:text-4xl font-serif font-bold text-[#008f45] mb-4">Struktur Organisasi &amp; Tata Kerja</h2> <p class="text-gray-800 font-serif text-base md:text-lg max-w-3xl mx-auto leading-relaxed">Dolor eiusmod mollit cupidatat officia consequat in elit tempor. Ex deserunt
        reprehenderit ad anim do adipiscing aute.</p></div>  <div class="flex gap-6 overflow-x-auto snap-x snap-mandatory pb-6 pt-2 [&amp;::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"><!--[-->`);
...
function BeritaDesa($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<section class="w-full bg-white py-16"><div class="max-w-[1500px] mx-auto px-6"><div class="text-center mb-12"><h2 class="text-3xl md:text-4xl font-serif font-bold text-[#008f45] mb-4">Berita Desa</h2> <p class="text-gray-800 font-serif text-base md:text-lg max-w-3xl mx-auto leading-relaxed">Dolor eiusmod mollit cupidatat officia consequat in elit tempor. Ex deserunt
        reprehenderit ad anim do adipiscing aute.</p></div> <div class="flex gap-8 overflow-x-auto snap-x snap-mandatory pb-10 pt-4 px-2 [&amp;::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"><!--[-->`);
...
function GaleriHome($$renderer) {
	...
	const barisAtasDuplikat = [...galeriAtas, ...galeriAtas];
	const barisBawahDuplikat = [...galeriBawah, ...galeriBawah];
	$$renderer.push(`<section class="w-full bg-white py-16 md:py-24 overflow-hidden svelte-bzevur"><div class="max-w-[1500px] mx-auto px-6 mb-12 svelte-bzevur"><div class="text-center svelte-bzevur"><h2 class="text-4xl md:text-[44px] font-serif font-bold text-[#007b3e] mb-4 svelte-bzevur">Galeri Desa</h2> <p class="text-gray-800 font-serif text-[17px] md:text-lg max-w-3xl mx-auto leading-relaxed svelte-bzevur">Dolor eiusmod mollit cupidatat officia consequat in elit tempor. Ex deserunt reprehenderit ad anim do adipiscing aute.</p></div></div> <div class="flex flex-col gap-4 md:gap-6 w-full svelte-bzevur"><div class="w-full overflow-hidden svelte-bzevur"><div class="track animate-scroll-left hover-pause gap-4 md:gap-6 svelte-bzevur"><!--[-->`);
...
function _page($$renderer) {
	...
	About($$renderer, {});
	$$renderer.push(`<!----> `);
	AdministrasiPenduduk($$renderer, {});
	$$renderer.push(`<!----> `);
	StrukturOrganisasi($$renderer, {});
	$$renderer.push(`<!----> `);
	ApbDesa($$renderer, {});
	$$renderer.push(`<!----> `);
	BeritaDesa($$renderer, {});

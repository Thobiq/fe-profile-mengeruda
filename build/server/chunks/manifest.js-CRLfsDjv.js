...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./0-GVhbrnYm.js')),
			__memo(() => import('./1-ByQCvc-7.js')),
			__memo(() => import('./2-DDSSin3V.js')),
			__memo(() => import('./7-oy4F_uGD.js'))
		],
		remotes: {
...
//# sourceMappingURL=manifest.js-CRLfsDjv.js.map

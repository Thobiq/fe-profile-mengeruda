...
import { s as splitCookiesString, S as SvelteKitError, a as Server } from './index.js-Cg7QL5cg.js';
import { m as manifest } from './manifest.js-DAndnCSb.js';
...
const prerendered = new Set(["/","/admin","/admin/administrator","/admin/apb-desa","/admin/apb-desa/form","/admin/berita","/admin/berita/tambah","/admin/demografi","/admin/galeri","/admin/peta","/admin/peta/form","/admin/profil-desa","/admin/struktur-organisasi","/apb-desa","/berita","/demografi","/login","/peta","/profil","/struktur-organisasi","/wisata-umkm"]);
...
//# sourceMappingURL=handler-EoibMo-F.js.map

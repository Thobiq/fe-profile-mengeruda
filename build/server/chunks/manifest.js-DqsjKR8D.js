...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./0-DILhXxZR.js')),
			__memo(() => import('./1-DDL6-axO.js')),
			__memo(() => import('./2-maPNB1hV.js')),
			__memo(() => import('./7-o3nLMF-e.js'))
		],
		remotes: {
...
//# sourceMappingURL=manifest.js-DqsjKR8D.js.map
